...
export type ActivityAction =
  ...
  | "DOCUSIGN_ENVELOPE_RESENT"
  | "DOCUSIGN_ENVELOPE_STATUS_CHANGED"
  | "DOCUSIGN_ENVELOPE_ATTACHED"
  | "DOCUSIGN_ENVELOPE_DETACHED"
  | "DOCUSIGN_SETTINGS_UPDATED"
  | "BLOG_POST_CREATED"
  | "BLOG_POST_UPDATED"
  | "BLOG_POST_DELETED"
