...
function ProfileHero({ profile, onEditClick, savedCount }: { profile: Profile; onEditClick: () => void; savedCount: number }) {
  ...
  {/* Profile content */}
  <div className="relative z-10 mx-auto max-w-[1600px] px-4 pb-[40px] pt-[36px] sm:px-6 sm:pb-[50px] sm:pt-[48px] lg:px-[76px] lg:pb-[60px] lg:pt-[87px]">
...
function SavedPropertiesSection({
  ...
  return (
    <section className="mx-auto max-w-[1600px] px-4 py-[32px] sm:px-6 sm:py-[40px] lg:px-[76px] lg:py-[48px]">
      {/* Tab bar */}
