...
export function LoginPageContent() {
  ...
  max-sm:tracking-[-0.26px]"
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-[4px]">
                  ...
                  <div
                    className={`flex items-center gap-2 bg-white border rounded-[12px] pl-[12px] pr-[10px] py-4 shadow-[0px_1px_2px_0px_rgba(228,229,231,0.24)] focus-within:border-[#1e4f86] transition-colors ${hasError ? "border-[#d1d5dc]" : "border-[#d1d5dc]"}`}
                  >
                    <IconEnvelope />
                    <input
                      type="email"
        ...
        {/* Footer */}
        <div className="shrink-0 flex items-center gap-[14px] px-10 max-sm:flex-wrap max-sm:justify-center max-sm:gap-x-3 max-sm:gap-y-2 max-sm:px-4 max-sm:text-center">
          <span
