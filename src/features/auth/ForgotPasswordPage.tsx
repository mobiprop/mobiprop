...
export function ForgotPasswordPageContent() {
  ...
  max-sm:tracking-[-0.26px]" style={{ ...poppins, fontWeight: 600 }}>
        ...
        {/* Footer */}
        <div className="shrink-0 flex items-center gap-[14px] px-10 max-sm:w-full max-sm:flex-wrap max-sm:justify-center max-sm:gap-x-2 max-sm:gap-y-1.5 max-sm:px-4 max-sm:py-3 max-sm:text-center">
  <span
