...
export function SecurityTab({ profile }: SecurityTabProps) {
  ...
  async function handleToggle2fa(enabled: boolean) {
    ...
    try {
      ...
      setTwoFactorError(t("security.errors.twoFactorFailed"));
    } finally {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (
      ...
      setError(t("security.errors.incomplete"));
      return;
    }

    if (newPassword.length < 8) {
      setError(t("security.errors.tooShort"));
      return;
    }
    ...
    try {
      ...
      setError(t("security.errors.generic"));
    } finally {
      setIsSaving(false);
    }
  }
      ...
      >
        ...
        <section className="flex min-w-0 flex-col">
          <h3
            ...
            style={mont}
          >
            {t("security.changePasswordHeading")}
          </h3>
        ...
        <div className="flex border-t border-[#e5e7eb] pt-6">
          ...
          >
            ...
            {isSaving ? t("security.updating") : t("security.updateSecurity")}
          </button>
        </div>
      </form>
    </div>
