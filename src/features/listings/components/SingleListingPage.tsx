...
function VideoPreviewSection({ videoUrl, title }: { videoUrl: string | null; title: string }) {
  ...
  return (
    <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto py-8 sm:py-12 lg:py-16">
      <h2
...
export function SingleListingPageContent({
  ...
  return (
    <div className="w-full bg-white">
      ...
      {/* Breadcrumb */}
      <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto py-5">
        <p
      ...
      {/* Photo Gallery */}
      <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto">
      ...
      <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto py-6 sm:py-8">
        <h2
          className="text-[#0d2138] mb-4 sm:mb-6 text-[22px] sm:text-[24px] leading-[28px]"
          style={{
            fontFamily: "Poppins, sans-serif",
      ...
      <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto pt-3 sm:pt-4">
        <h2
          className="text-[#0d2138] mb-4 sm:mb-6 text-[22px] sm:text-[24px] leading-[28px]"
          style={{
            fontFamily: "Poppins, sans-serif",
      ...
      <div className="bg-[#F8FAFC]">
        <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto py-7">
      ...
      {listingAmenities.length > 0 ? (
        <div className="w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto py-8 sm:py-12 lg:py-[100px]">
          <h2
            className="text-[#0d2138] mb-4 sm:mb-6 text-[22px] sm:text-[24px] leading-[28px]"
            style={{
              fontFamily: "Poppins, sans-serif",
