...
function LocationSection() {
  const { t } = useTranslation("contact");
  return (
    <section className="max-w-[var(--space-fluid-container-max)] mx-auto px-4 sm:px-6 lg:px-[60px] pt-[50px] sm:pt-[60px] lg:pt-[80px] pb-[50px] sm:pb-[60px] lg:pb-[80px]">
  {/* Heading */}
...
function ConsultationBannerSection() {
  ...
  <div className="relative z-10 w-[calc(100%-32px)] sm:w-[calc(100%-35px)] max-w-[var(--space-fluid-container-max)] mx-auto flex justify-center">
