    ...
    <section className="bg-white py-16 lg:py-20">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="lg:w-[340px] flex-shrink-0 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-[7px] h-[7px] rounded-full bg-[#4896b6]" />
                <span
                  className="text-[18px] font-medium text-[#6a7282]"
            ...
            <div className="flex gap-3 mt-8 lg:mt-0">
              <button className="w-14 h-14 rounded-[13px] bg-[#d1d5dc] flex items-center justify-center hover:bg-gray-300 transition-colors">
                <svg width="22" height="18" viewBox="0 0 18.0006 15.0008" fill="none">
                  <path d={svgPaths.p33185f40} fill="#2B3038" />
                </svg>
              </button>
              <button className="w-14 h-14 rounded-[13px] bg-[#1e4f86] border border-[#4b729e] flex items-center justify-center rotate-180 hover:bg-[#1a4470] transition-colors">
                <svg width="22" height="18" viewBox="0 0 18.0006 15.0008" fill="none">
          ...
          <div className="flex-1">
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                space that felt modern, functional, and timeless. Their approach
                reshaped how our building stands in the community.
              </blockquote>
            </div>

            {/* Author */}
            <div className="flex items-center gap-4 mt-8">
              <div className="w-[80px] h-[70px] rounded-[16px] overflow-hidden flex-shrink-0">
                <img
