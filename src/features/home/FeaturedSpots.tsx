      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col items-center gap-4 mb-10">
          ...
          <div className="text-center">
            <h2
              className="text-[32px] lg:text-[44px] font-semibold text-[#0d2138] leading-tight"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              Featured Spots
            </h2>
            <p
              className="mt-3 text-[16px] text-[#2b3038] max-w-[460px]"
              style={{ fontFamily: "Montserrat, sans-serif" }}
            >
          ...
          {spots.slice(0, 2).map((spot, i) => (
            <div key={spot.id} className="flex flex-col gap-5">
              ...
              <div className="flex items-start justify-between">
                ...
                <button
                  className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 border border-[#d1d5dc] ${
